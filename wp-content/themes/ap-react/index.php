...
<meta charset="utf-8" />
    <link rel="shortcut icon" href="/wp-content/themes/ap-react/favicon.ico" />
    ...
    <!--
        ...
        Notice the use of "php echo $TEMPLATE_PATH;" and /wp-content/themes/ap-react in the tags above.
        Both will be replaced with the URL of the `public` folder during the build (/wp-content/themes/ap-react) or
        at render time (php echo $TEMPLATE_PATH;)
        Only files inside the `public` folder can be referenced like this.

        Unlike "/favicon.ico" or "favicon.ico", "/wp-content/themes/ap-react/favicon.ico" will
        work correctly both with client-side routing and a non-root public URL.
        Learn how to configure a non-root public URL by running `npm run wpbuild`.
    -->
    <title>React WordPress Theme</title>
<link href="/wp-content/themes/ap-react/static/css/main.chunk.css?2f39f0fad95f1788568c" rel="stylesheet"></head>
    <body>
    <noscript>
    ...
    -->
    <script src="/wp-content/themes/ap-react/static/js/bundle.js?2f39f0fad95f1788568c"></script><script src="/wp-content/themes/ap-react/static/js/0.chunk.js?2f39f0fad95f1788568c"></script><script src="/wp-content/themes/ap-react/static/js/main.chunk.js?2f39f0fad95f1788568c"></script></body>
</html>
